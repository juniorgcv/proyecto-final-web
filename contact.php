...
if ($_POST) {
    ...
    //preparar insercion
    $sentencia = $conexion->prepare("INSERT INTO contacto (nom,correo,asunto,mensaje)
        ...
        <div class="container-xxl py-5">
            <div class="container py-5 px-lg-5">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    <p class="section-title text-secondary justify-content-center"><span></span>Contactenos<span></span></p>
                    <h1 class="text-center mb-5">Contactenos para cualquier consulta</h1>
                </div>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="asunto" name="asunto" placeholder="Subject">
                                            <label for="asunto">Asunto</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a message here" id="mensaje" name="mensaje" style="height: 150px"></textarea>
        ...
        <div class="container-fluid bg-primary text-light footer wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <p class="section-title text-white h5 mb-4">Enlaces rapidos<span></span></p>
